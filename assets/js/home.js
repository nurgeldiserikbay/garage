...
;// CONCATENATED MODULE: ./src/assets/scripts/home.js
...
gsapWithCSS.utils.toArray(".feedback path").forEach(function (elem) {
...
gsapWithCSS.utils.toArray(".feedback span").forEach(function (elem) {
  ScrollTrigger_ScrollTrigger.create({
    trigger: elem,
    start: "top 90%",
    once: true,
    onEnter: function () {
      elem.style.opacity = "0";
      gsapWithCSS.timeline({}).from(elem, {
        autoAlpha: 0,
      }).to(elem, {
        duration: 0.5,
        delay: getRandomInt(1, 3) / 10,
